-- Single USDC Fixed Converter
-- Uses direct color replacement instead of CSS injection for reliable color application
...
-- Apply direct color replacement to SVG string
local function applyDirectColors(svgString)
    local processedSVG = svgString
    
    -- Replace CSS classes with direct fill colors
    ...
    -- Wrap in proper SVG document structure (no style block needed)
...
local function convertUSDCFixed()
    print("Starting USDC fixed conversion (direct color replacement)...")
    print("USDC colors:")
    ...
    print("")
    print("USDC fixed conversion completed!")
